...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handleAddOption(option) {
      ...
      if (this.state.options.includes(option)) return 'This element already exists';
  ...
  _createClass(Options, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'button',
          { onClick: this.props.handleDeleteOptions, type: 'button' },
          'Remove All'
        ),
        React.createElement(
          'p',
        ...
        React.createElement(
          'ul',
          null,
          this.props.options.map(function (elem, i) {
            return React.createElement(Option, { key: i, optionText: elem });
          })
        )
      );
    }
