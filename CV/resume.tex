...
\name{Mario}{Jiménez}
\position{Student in Computer Science}
\address{Paseo de los Duraznos 171, Paseos de Taxqueña, 04250 Mexico City, Mexico}

\mobile{(+52) 961 209-6280}
...
% \makecvfooter
%   {\today}
%   {Mario Jiménez~~~·~~~Curriculum Vitae}
%   {\thepage}
